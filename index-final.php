...
<head>
  ...
  <title>People - The New Facebook </title>
  <link rel="stylesheet" type="text/css" href="style.css" />
</head>
<body>
  <h3>People - The New Facebook </h3>
...
<?php
  ...
  $query = "SELECT user_id, first_name, picture FROM people_user WHERE first_name IS NOT NULL ORDER BY join_date DESC LIMIT 5";
